...
void CKinectFusionColorBasics::ProcessDepth()
{
	...
	/*std::ofstream myFile("colorcolor", std::ios::out | std::ios::binary);
	if (myFile)
	{
...
/// </returns>
HRESULT CKinectFusionColorBasics::GetScreenshotFileName(wchar_t *screenshotName, UINT screenshotNameSize)
{
...
void CKinectFusionColorBasics::ProcessColor()
{
	HRESULT hr;
	NUI_IMAGE_FRAME imageFrame;
